...
public abstract class BatchTiledMapRendererAdapted implements TiledMapRenderer, Disposable {
	...
	public BatchTiledMapRendererAdapted (TiledMap map) {
		this(map, 1.0f);
	}

	public BatchTiledMapRendererAdapted (TiledMap map, float unitScale) {
		this.map = map;
	...
	public BatchTiledMapRendererAdapted (TiledMap map, Batch batch) {
		this(map, 1.0f, batch);
	}

	public BatchTiledMapRendererAdapted (TiledMap map, float unitScale, Batch batch) {
		this.map = map;
		this.unitScale = unitScale;
		this.viewBounds = new Rectangle();
		this.batch = batch;
	...
	protected void beginRender () {
		...
		//batch.begin();										//Para poder desenhar sprites
	}

	/** Called after the rendering of all layers ended. */
	protected void endRender () {
		//batch.end();											//Para poder desenhar sprites
	}
